...
def db():
    try:
        ...
        table_name = 'denis_primoz_test_Dsdasdasdasd'
...
def update_flask_app(insertions):
    url = 'http://127.0.0.1:5000/update_metrics'
    data = {
    ...
    try:
        ...
        print(f"Failed to update Flask app: {e}")
...
def pulsar(ch_client, db_name, table_name, pulsar_client, topic):
    ...
    try:
        for i in range(10000):  #number of insertions
            message_data = {
                "ID": i,
